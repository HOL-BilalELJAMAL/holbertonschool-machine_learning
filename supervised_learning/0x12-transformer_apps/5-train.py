...
"""
5-train.py
Module that defines a class called LearningSchedule
"""
...
class LearningSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
    ...
    def __call__(self, step):
        """
        Function that evaluates the learning rate for the given step
        """
...
def train_transformer(N, dm, h, hidden, max_len, batch_size, epochs):
    ...
    def loss_function(actual, prediction):
        """
        Function that calculate the loss from actual value and the prediction
        """
    ...
    def accuracy_function(actual, prediction):
        """
        Function that calculates the accuracy of the prediction
        """
