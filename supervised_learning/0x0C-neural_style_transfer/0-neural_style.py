...
"""
0-neural_style.py
Module that defines a class called NST
"""
...
class NST:
    """NST Class that performs tasks for neural style transfer style_layers"""
    ...
    def scale_image(image):
        ...
        resized_image = tf.image.resize_images(image, (h_new, w_new),
                                               method=tf.image.
